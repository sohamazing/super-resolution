...
class SuperResConfig:
    ...
    ESRGAN_NUM_FEATURES = 64
    ESRGAN_NUM_RRDB = 23

    # --- Fusion-SRGAN Specific ---
    FUSION_SRGAN_EPOCHS: int = 1000
    FUSION_SRGAN_LR: float = 2e-4 # 1e-4
    FUSION_SRGAN_GEN_FEATURES = [48, 96, 128] # larger = [64, 128, 256]
    FUSION_SRGAN_DIS_FEATURES = [32, 64, 128, 256] # larger = [64, 128, 256, 512]
    FUSION_SRGAN_EMBED_DIM = 180
    FUSION_SRGAN_NUM_HEADS = 6 # num attention heads
    FUSION_SRGAN_WINDOW_SIZE = 8
    FUSION_SRGAN_NUM_SWIN_BLOCKS = 4 # larger = 6
    FUSION_SRGAN_DROPOUT = 0.1
